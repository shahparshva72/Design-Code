...
//  Design+Code
//
//  Created by Parshva Shah on 7/4/20.
    ...
    var body: some View {
        ZStack {
            Image(systemName: "sun.max")
                ...
                .rotation3DEffect(Angle(degrees: press ? 20 : 0), axis: (x: 10.0, y: -10.0, z: 0.0))
            
            Image(systemName: "moon")
                .font(.system(size: 44, weight: .light))
                .offset(x: press ? 0 : 90, y: press ? 0 : 90)
                .rotation3DEffect(Angle(degrees: press ? 0 : 20), axis: (x: -10.0, y: 10.0, z: 0.0))
        }
        ...
        .background(
            ...
            .overlay(
                Circle()
                    ...
                    .stroke(LinearGradient(gradient: Gradient(colors: [Color(#colorLiteral(red: 0.3647058904, green: 0.06666667014, blue: 0.9686274529, alpha: 1)), Color(#colorLiteral(red: 0.5568627715, green: 0.3529411852, blue: 0.9686274529, alpha: 1))]), startPoint: .topLeading, endPoint: .bottomLeading), style: StrokeStyle(lineWidth: 5, lineCap: .round))
